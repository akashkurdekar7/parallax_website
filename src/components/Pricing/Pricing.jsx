    ...
    <section className="pricing" id="pricing">
      <div className="d-flex justify-content-center align-items-center">
        <div className="container">
          ...
          <div className="mt-5">
            <div className="row">
              <div className="col-12 col-lg-6 my-auto text-center text-md-start">
                <h3 className="fw-semibold">
                  Frequently Asked <span className="font-sign">Questions</span>
                </h3>
                <p className="text-muted">
                  Have questions? Here are some common questions and answers to
                  help you out!
                </p>
              </div>
              ...
              <div className="col-12 col-lg-6">
                <div className="accordion" id="faqAccordion">
                  {faqs.map((faq, idx) => {
                    ...
                    return (
                      <div className="accordion-item mb-2 shadow" key={idx}>
